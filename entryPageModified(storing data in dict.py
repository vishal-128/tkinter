# -*- coding: utf-8 -*-
"""
Created on Sat Sep 25 18:58:12 2021
...
def getvals():
    print(f"{namevalue.get(),gendervalue.get(),phonevalue.get(),payment_modevalue.get(),emergencyvalue.get(),foodservicevalue.get()}")
    
    with open("record.txt","a") as f:  # a stands for append
        f.write(f"{namevalue.get(),gendervalue.get(),phonevalue.get(),payment_modevalue.get(),emergencyvalue.get(),foodservicevalue.get()}\n")
